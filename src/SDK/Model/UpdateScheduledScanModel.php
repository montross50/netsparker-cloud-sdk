...
class UpdateScheduledScanModel
{
     ...
     * Represents a model for carrying out scan time window settings.
     *
     * @return ScanTimeWindowViewModel
     */
    public function getTimeWindow(): ?ScanTimeWindowViewModel
    {
     ...
     * Represents a model for carrying out scan time window settings.
     *
     * @param ScanTimeWindowViewModel $timeWindow
     *
     * @return self
     */
    public function setTimeWindow(?ScanTimeWindowViewModel $timeWindow): self
    {
