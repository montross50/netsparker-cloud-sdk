...
class AgentGroupsNew extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    /**
     * @param \Montross50\NetsparkerCloud\SDK\Model\AgentGroupApiNewModel $model the new agent group model
     */
    public function __construct(\Montross50\NetsparkerCloud\SDK\Model\AgentGroupApiNewModel $model)
    {
        $this->body = $model;
    }
    ...
    {
        return '/api/1.0/agentgroups/new';
    }
