...
class NotificationsNew extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    /**
     * @param \Montross50\NetsparkerCloud\SDK\Model\NewScanNotificationApiModel $model the new scan notification model
     */
    public function __construct(\Montross50\NetsparkerCloud\SDK\Model\NewScanNotificationApiModel $model)
    {
        $this->body = $model;
    }
    ...
    {
        return '/api/1.0/notifications/new';
    }
