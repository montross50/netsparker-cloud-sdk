...
class NotificationsGet extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    protected $id;
    ...
    {
        return str_replace(['{id}'], [$this->id], '/api/1.0/notifications/get/{id}');
    }
