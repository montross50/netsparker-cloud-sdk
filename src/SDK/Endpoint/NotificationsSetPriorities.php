...
class NotificationsSetPriorities extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    /**
    ...
    {
        return '/api/1.0/notifications/setpriorities';
    }
    ...
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer)
    {
        ...
        if (400 === $status) {
            throw new \Montross50\NetsparkerCloud\SDK\Exception\NotificationsSetPrioritiesBadRequestException();
        }
    }
}
