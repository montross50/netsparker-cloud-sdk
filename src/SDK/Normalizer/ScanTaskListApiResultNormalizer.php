...
class ScanTaskListApiResultNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Montross50\\NetsparkerCloud\\SDK\\Model\\ScanTaskListApiResult';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Montross50\NetsparkerCloud\SDK\Model\ScanTaskListApiResult;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Montross50\NetsparkerCloud\SDK\Model\ScanTaskListApiResult();
        ...
        if (property_exists($data, 'List')) {
            ...
            foreach ($data->{'List'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Montross50\\NetsparkerCloud\\SDK\\Model\\ScanTaskModel', 'json', $context);
            }
