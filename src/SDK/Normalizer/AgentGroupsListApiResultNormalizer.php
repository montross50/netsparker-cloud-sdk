...
class AgentGroupsListApiResultNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Montross50\\NetsparkerCloud\\SDK\\Model\\AgentGroupsListApiResult';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Montross50\NetsparkerCloud\SDK\Model\AgentGroupsListApiResult;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Montross50\NetsparkerCloud\SDK\Model\AgentGroupsListApiResult();
        ...
        if (property_exists($data, 'List')) {
            ...
            foreach ($data->{'List'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Montross50\\NetsparkerCloud\\SDK\\Model\\AgentGroupApiModel', 'json', $context);
            }
