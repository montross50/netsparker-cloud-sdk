...
class WebsiteGroupListApiResultNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Montross50\\NetsparkerCloud\\SDK\\Model\\WebsiteGroupListApiResult';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Montross50\NetsparkerCloud\SDK\Model\WebsiteGroupListApiResult;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Montross50\NetsparkerCloud\SDK\Model\WebsiteGroupListApiResult();
        ...
        if (property_exists($data, 'List')) {
            ...
            foreach ($data->{'List'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Montross50\\NetsparkerCloud\\SDK\\Model\\WebsiteGroupApiModel', 'json', $context);
            }
