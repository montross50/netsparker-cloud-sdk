...
class NewScanNotificationApiModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Montross50\\NetsparkerCloud\\SDK\\Model\\NewScanNotificationApiModel';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Montross50\NetsparkerCloud\SDK\Model\NewScanNotificationApiModel;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Montross50\NetsparkerCloud\SDK\Model\NewScanNotificationApiModel();
